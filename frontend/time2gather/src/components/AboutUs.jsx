...
const AboutUs = () => {
  return (
    <div
      ...
      <p style={{ fontSize: 'medium', lineHeight: '25px', maxWidth: '460px', color: "white" }}>
      ...
      <p style={{ fontSize: 'medium', lineHeight: '25px', maxWidth: '460px', marginBottom: '25px', color: "white" }}>Below is a tutorial video on how to use Time2gather:</p>
      <iframe
        width='460'
        height='315'
